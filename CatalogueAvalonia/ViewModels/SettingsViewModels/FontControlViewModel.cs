...
public partial class FontControlViewModel : ViewModelBase
{
    ...
    public FontControlViewModel()
    {
        _fonts.AddRange(FontManager.Current.SystemFonts);
        SelectedFont = FontFamily.Default;
        Description = "Это описание";
    }
    public FontControlViewModel(IMessenger messenger, SettingModel settingModel) : base(messenger)
    {
