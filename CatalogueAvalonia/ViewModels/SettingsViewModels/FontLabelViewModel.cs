...
public partial class FontLabelViewModel : ViewModelBase
{
    ...
    public FontLabelViewModel()
    {
        _fonts.AddRange(FontManager.Current.SystemFonts);
        SelectedFont = FontFamily.Default;
        Description = "Это описание";
    }
    public FontLabelViewModel(IMessenger messenger, SettingModel settingModel) : base(messenger)
    {
